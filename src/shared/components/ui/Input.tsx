    ...
    if (variant === "underline") {
        return (
            <input
                {...props}
                className={cn(
                    "w-full border-b-2 border-transparent bg-transparent pb-2 font-black text-text transition-colors outline-none placeholder:text-gray-300",
    ...
    return (
        <div className={cn("relative", containerClassName)}>
            ...
            <input
                {...props}
                className={cn(
                    "placeholder:text-muted h-12 w-full rounded-2xl border-2 border-gray-100 bg-white text-sm font-black text-text transition-all outline-none placeholder:font-bold",
