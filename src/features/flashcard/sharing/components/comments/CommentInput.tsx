        ...
        <div className="flex flex-col gap-1.5">
            ...
            >
                <textarea
                    ...
                    rows={compact ? 2 : 3}
                    className="text-text w-full resize-none rounded-xl bg-transparent px-3 py-2.5 text-sm font-medium outline-none placeholder:text-gray-400 disabled:opacity-50"
