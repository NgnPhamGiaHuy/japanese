        ...
        <div className="bg-bg min-h-dvh">
            ...
            >
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="border-katakana-strong bg-katakana flex flex-col justify-between rounded-4xl border-2 border-b-8 p-6 text-white shadow-sm">
                        <div>
                        ...
                        <Button
                            variant="ghost"
                            className="text-katakana mt-4 bg-white hover:bg-gray-100"
                ...
                <div>
                    ...
                    <Link
                        href="/kana"
                        className="border-hiragana-hover from-hiragana to-katakana focus-visible:ring-katakana block rounded-4xl border-2 border-b-8 bg-gradient-to-br p-6 text-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-[2px] active:border-b-4"
                    >
                    ...
                    <div className={`flex flex-col ${SPACING.cardGap}`}>
                        {recentLessons.map((lesson) => (
                            <Link key={lesson.id} href={`/flashcard/${lesson.id}`}>
                                ...
                                >
                                    <div>
                                        <h3 className="text-text text-lg font-black group-hover:text-black">
                                            {lesson.title}
                                        </h3>
                                    ...
                                    <div className="border-katakana-strong bg-katakana group-hover:bg-katakana-hover rounded-2xl border-b-4 p-4 text-white transition-colors">
