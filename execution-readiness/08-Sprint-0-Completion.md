...
## Status: ⚠️ **READY FOR SPRINT 1 — with two owner confirmations outstanding**

Five of seven conditions are **closed by execution**. Two (S0-4, S0-5) are **prepared but require a human decision** that cannot be self-served: naming the accountable person. They are recorded below with everything except the name.
...
| **S0-4** | Name the owners ([INTENT], [GCP], hosting) | F-8: the sole-developer-is-also-product-owner assumption is stated once, hedged, and is load-bearing for T-120b | §7 | **Requires a human answer** | Three roles map to named people | ⚠️ **PREPARED — awaiting confirmation** |
| **S0-5** | PF-6 — owner + review-by on every gated question, **including Q-4** | A ledger row missing owner or review-by is invalid by T-120a's own format; T-120b cannot pass | §7 | Register prepared; owner column blocked on S0-4 | Every gated question has owner + review-by | ⚠️ **PREPARED — blocked on S0-4** |
...
## 7 — Owner register (S0-4, S0-5) — ⚠️ **PREPARED, AWAITING A NAME**
...
| Role | Answers | Owner |
|---|---|---|
| [INTENT] | Q-5, Q-7, Q-8, Q-11, Q-12, Q-13, Q-17, NQ-3, NQ-7 | ☐ **to name** |
| [GCP]/[OPS] | Q-4, Q-6, Q-9, Q-10, NQ-1 | ☐ **to name** |
| Hosting / project identity | Q-1, Q-2 (T-118d) | ☐ **to name** |
...
|---|---|---|---|
| **S0-4 / S0-5** — name owners; register Q-4 | ⚠️ Open | **T-120b** (3 of Sprint 1's 8 days) | One sentence from the project owner |
